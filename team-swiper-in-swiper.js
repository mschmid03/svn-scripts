...
const teamController = new swiper_1.default(".team-controller_swiper", {
    ...
    modules: [modules_1.Navigation, modules_1.Autoplay, modules_1.EffectCoverflow],
    navigation: {
        enabled: true,
...
const targetNodes = document.querySelectorAll(".team-uebersicht_internal_controller-container");
    ...
    const callback = (mutationList, observer) => {
        for (const mutation of mutationList) {
            if (mutation.addedNodes.length > 0) {
                const controllerSlideArray = targetNode.querySelectorAll(".swiper-slide");
                ...
                if (!(controllerSlideArray.length <= 1)) {
                    ...
                    if (teamAttribute !== null) {
                        ...
                        observer.disconnect();
                        internalSlider[i][0] = new swiper_1.default(`.team-uebersicht_internal_controller-container[team="${teamAttribute}"] .team-uebersicht_internal_controller`, {
                            effect: "slide",
                            grabCursor: true,
                            ...
                            initialSlide: 0,
                            slidesPerView: "auto",
                            modules: [modules_1.Navigation, modules_1.Manipulation],
                            navigation: {
                                enabled: true,
                        ...
                        realSlides.sort((a, b) => a.getAttribute(indexAttribute) >
                        ...
                        internalSlider[i][1] = new swiper_1.default(`.team-uebersicht_internal_controlled[team="${teamAttribute}"]`, {
                            slidesPerView: 1,
                            effect: "fade",
                            // enabled: false,
                            centeredSlides: true,
